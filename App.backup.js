...
import {
  ...
  Alert, Platform, Modal, ActivityIndicator, Dimensions,
...
// react-native-view-shot: dipakai untuk share rekap sebagai gambar
// Tersedia setelah build berikutnya (package sudah di-install)
let captureRef = null;
...
// Berlaku saat app foreground; di background Android menjalankan handler ini juga
...
async function setOnboardingDone(db) {
...
function OnboardingScreen({ onDone }) {
  ...
  return (
    <View style={{ flex:1, backgroundColor:'#071018' }}>
      ...
      {/* Skip — hanya tampil di slide 1 & 2 */}
      {current < TOTAL - 1 && (
      ...
      {/* Slides — ScrollView horizontal pagingEnabled */}
      <ScrollView
        ref={scrollRef}
        horizontal
        pagingEnabled
      ...
      <View style={{ position:'absolute', bottom:0, left:0, right:0,
        ...
        <TouchableOpacity onPress={handleNext}
          style={{ width:'100%', paddingVertical:16, borderRadius:16,
            ...
            shadowColor: slide.accent, shadowOpacity:0.4, shadowRadius:12, elevation:6 }}>
